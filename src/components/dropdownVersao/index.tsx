...
type DropdownProps = {
  ...
  inputStyle?: any;
  touched?: any;
  onPressMenuItem: (item: any) => void;
};

const DropdownVersao: React.FC<DropdownProps> = (props) => {
  const {
    title,
    value,
    errors,
    ...
    >
      ...
      {content.length === 0 && (
        <Menu.Item
          style={styles.menuItem}
          contentStyle={styles.menuItemContent}
          title={"Selecione algum modelo de veículo ou ano modelo existente"}
        />
      )}
    </Menu>
  );
